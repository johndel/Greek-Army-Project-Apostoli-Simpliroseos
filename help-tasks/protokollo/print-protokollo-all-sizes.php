...
function fixname($name) {
  ...
  $materials_no_table = "SELECT * FROM a_materials WHERE id = 30 OR id = 31 ORDER BY `a_materials`.`name`";
...
<br />
<div style="margin: 0 auto; text-align: center; font-size: 20px; font-weight: bold; text-decoration: underline; line-height: 28px;">
...
<?php include("print-protokollo-with-oct-number-a.php") ?>
