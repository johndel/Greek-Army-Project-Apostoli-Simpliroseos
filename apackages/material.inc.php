	...
	if (isset($_POST['a_materials']) && in_array($row['id'],
		...
		<div class="disabled-options"> 
				  ...
				  while ($row = $sizes_result->fetch_assoc()) { ?> 
					<option value="<?php echo $row['id']; ?>" data-materialsize="<?php echo $row['material_id'] ?>"><?php echo $row['size']; ?></option> 
				  <?php } ?> 
		</div>
</td>
<td>
	<input name="quantity[]" autocomplete="off" type="text" size="3" value="" class="amaterial_number"></input>
</td>
<td>
