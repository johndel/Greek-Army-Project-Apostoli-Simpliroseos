...
<?php $sql = 'SELECT * FROM b_materials'; ?>
<?php $result = $conn->query($sql) or die(mysqli_error()); ?>
<h4>Υλικά Πίνακα Β</h4>
<h3>Σύνολο: <?php echo $result->num_rows; ?> υλικά</h3>
<a href="new.php" class="btn btn-success"><i class="icon-plus-sign"></i> Προσθήκη νέου υλικού - Πίνακα B</a>

<table border=1 class="nice-table" id="myTable">
<thead>
