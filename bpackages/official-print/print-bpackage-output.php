...
<?php
	...
	$function_query = "SELECT * FROM `b_materials` WHERE id=".$_GET['material_id'];
	$row_query = mysql_query($function_query) or die("test");
	$row = mysql_fetch_assoc($row_query) or die(mysql_error());
	$has_sizes = check_material_sizes($_GET['material_id'], 'b');
?>
...
<?php include("prepare_variables_size.php"); ?>
	<div style="text-align: center; font-size: 10pt;">
		<span style="text-decoration:underline">ΠΙΝΑΚΑΣ <?php echo $_GET['pinakas']; ?></span><br />
		<div>
			<span style="text-decoration:underline">ΠΟΣΟΣΤΙΑΙΑ ΑΝΑΛΟΓΙΑ ΜΕΓΕΘΩΝ</span>
			<div style="font-weight: bold;"><span style="text-decoration:underline"><?php echo $row['name']; ?> ΕΦΕΔΡΩΝ</span></div>
		</div>
	</div>
	<table border="1" style="text-align: center;">
		<tr style="font-weight: bold">
			...
			<td style="width: 30pt">&nbsp;<br /><img src="/images/print/provlepomena.png" />&nbsp;<br /></td>
			<td style="width: 30pt">&nbsp;<br /><img src="/images/print/iparxonta.png" />&nbsp;<br /></td>
			<td style="width: 30pt">&nbsp;<br /><img src="/images/print/eliponta.png" />&nbsp;<br /></td>
			<td style="width: 30pt">&nbsp;<br /><img src="/images/print/pleonazonta.png" />&nbsp;<br /></td>
			<td style="width: 170pt">&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;<br />ΠΑΡΑΤΗΡΗΣΕΙΣ</td>
		</tr>
		<?php 
		...
		<tr>
			...
			<td><?php if(is_numeric($size_row['size'])) { $isnum = "No"; } else { $isnum = ""; } ?><?php echo $isnum." ".$size_row['size']; ?></td><td><?php echo $size_row['percentage']; ?>%</td><td style="width: 30pt"><?php include("sum-all-materials/provlepomena.php"); ?></td><td style="width: 30pt"><?php include("sum-all-materials/iparxonta-print.php"); ?></td><td style="width: 30pt"><?php include("sum-all-materials/eliponta.php"); ?></td><td style="width: 30pt"><?php include("sum-all-materials/pleonazonta.php"); ?></td><td>&nbsp;</td>
		</tr>
		
		
		<?php } ?>
		<tr><td colspan="3" style="font-weight: bold;">ΓΕΝΙΚΟ ΣΥΝΟΛΟ</td><td><?php echo $percentage; ?>%</td><td><?php echo $material_prov_power; ?></td><td><?php echo $sum_iparxonta; ?></td><td><?php if($elipon_sum < 0) { echo "0"; } else { echo $elipon_sum; } ?></td><td><?php if($pleonazon_sum < 0) { echo "0"; } else { echo $pleonazon_sum; } ?></td><td>&nbsp;</td></tr>
	</table>
<?php } ?>