...
<a class="btn btn-primary" href="print-general-store-table.php"><i class="icon-print"></i> Εκτύπωση Πίνακα Εναποθηκευμένου Υλικού</a>
-
<a class="btn btn-primary" href="print-general-store-table-1.php"><i class="icon-print"></i> Εκτύπωση Πίνακα Εναποθηκευμένου Υλικού για την <?php $a_subunit = select_record("subunits", 1); echo $a_subunit[1]; ?></a><br />
-
<a class="btn btn-primary" href="print-general-store-table-2.php"><i class="icon-print"></i> Εκτύπωση Πίνακα Εναποθηκευμένου Υλικού για την </a><br />
-
<a class="btn btn-primary" href="print-general-store-table-3.php"><i class="icon-print"></i> Εκτύπωση Πίνακα Εναποθηκευμένου Υλικού</a><br />
-
<a class="btn btn-primary" href="print-general-store-table-4.php"><i class="icon-print"></i> Εκτύπωση Πίνακα Εναποθηκευμένου Υλικού</a><br />
-
<a class="btn btn-primary" href="print-general-store-table-5.php"><i class="icon-print"></i> Εκτύπωση Πίνακα Εναποθηκευμένου Υλικού</a><br />
-
<a class="btn btn-primary" href="print-general-store-table-6.php"><i class="icon-print"></i> Εκτύπωση Πίνακα Εναποθηκευμένου Υλικού</a><br />
-
<a class="btn btn-primary" href="print-general-store-table-7.php"><i class="icon-print"></i> Εκτύπωση Πίνακα Εναποθηκευμένου Υλικού</a><br />
